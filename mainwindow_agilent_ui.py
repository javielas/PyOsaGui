...
################################################################################
## Form generated from reading UI file 'mainwindow_agilent.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sensitivityDoubleSpinBox = QDoubleSpinBox(self.centralwidget)
        self.sensitivityDoubleSpinBox.setObjectName(u"sensitivityDoubleSpinBox")

        self.horizontalLayout.addWidget(self.sensitivityDoubleSpinBox)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1886, 39))
